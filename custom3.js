...
//Rallenta la scomparsa dei tooltip (impostato a 7 secondi)[inserito da L. S. il 23_03_2016]
RD3_TooltipManager.DelayHide = 7000;
...
// ****************************************************
// FUNZIONE RD2 Corregge il bug del calendario su firfox che non riesce a leggere la proprieta "Name" dell'iframe. Mettendolo nel try catch il problema si risolve
	...
	var config = new Object();
		...
		//Configurazioni Toolbar ..... tra parentesi quadre i pulsanti da ragruppare in una sezione, con '/' si va a capo e con '-' si lascia uno spazio
			...
			[
				...
				['Bold','Italic','Underline'],// (15/03/2013-tolto l'omissis) 20/06/13 tolo il sottolineato perchè jasper report lo traduce come uno strike
				//['Bold','Italic','Strike']
			...
			[
				...
				['Bold','Italic','Strike','Underline'], // (15/03/2013-tolto l'omissis)
				//['Bold','Italic','Strike','Underline','Giustifica','Omissis'],
				['JustifyLeft','JustifyCenter','JustifyRight','JustifyBlock'],
...
PField.prototype.CreateFlashUploader = function()
{
  ...
  else
  {
	...
	//modifico la dimensione della cartella icona
    settings.button_width = "40";
    settings.button_height = "40";
  }
  //
...
//*************************************************************************************************************************************
// Assistenza 001071-2015
// Un errore javascript che non veniva catchato, impostava StopChange a false e bloccava tutte le comunicazioni tra client e server. 
// quindi le modifiche ai campi del pannello non venivano sentite
//*************************************************************************************************************************************
...
/**
* ****** Inizio Patch NPQ02580 *******
* NPQ02580 - corretta in 15.5 - ASS 001218-2016
* Aggiunto con Assistenza InDe 27/10/2016
* Serve per non perdere l'attivazione di un pulsante attivo dopo l'aggiornamento dei dati
* [vedi RM #6756]
*/
